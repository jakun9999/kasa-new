...
/** Étoile Figma (`figma-export/icons/star_icon.svg`). Fill Main red par défaut. */
export function StarIcon({ className = "size-4 text-kasa-red" }: StarIconProps) {
  return (
    <svg
      width="15"
      height="17"
